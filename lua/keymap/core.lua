...
local plug_map = {
    ...
    ["n|<Leader>sr"] = map_cmd(":%s/<C-R><C-W>//gI<left><left><left>","Replace word under cursor"):with_noremap():with_silent(),
    -- Replace word under cursor on Line (case-sensitive)
    -- nmap <leader>sl :s/<C-R><C-W>//gI<left><left><left>
    ["n|<Leader>sl"] = map_cmd(":s/<C-R><C-W>//gI<left><left><left>","Replace word under cursor on Line"):with_noremap():with_silent(),
    ...
    ["n|<Leader>sv"] = map_cmd([[<Cmd>source $MYVIMRC<cr> <bar> :lua vim.notify('Sourced init.vim')<cr>]], "Source init.lua")
        :with_silent()
        :with_noremap(),
    ...
    ["n|<localleader>wh"] = map_cmd([[<C-W>t <C-W>K]],"horizontally split windows to vertical splits"):with_noremap():with_silent(),
    -- Change two vertically split windows to horizontal splits
    ["n|<localleader>wv"] = map_cmd([[<C-W>t <C-W>H]],"vertically split windows to horizontal splits"):with_noremap():with_silent(),
