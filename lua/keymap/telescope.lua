...
local plug_map = {
    ["n|<Leader>U"] = map_cmd('<cmd>lua require"utils.telescope".find_updir()<CR>', "Up dir")
        :with_noremap()
        :with_silent(),
    ["n|<Leader>ff"] = map_cmd('<cmd>lua require"utils.telescope".find_files()<CR>', "Find Files")
        :with_noremap()
        :with_silent(),
    ["n|<Leader>fF"] = map_cmd('<cmd>lua require"utils.telescope".files()<CR>', "Current dir files")
        :with_noremap()
        :with_silent(),
    ["n|<Leader>fn"] = map_cmd('<cmd>lua require"utils.telescope".find_notes()<CR>', "My notes")
        :with_noremap()
        :with_silent(),
    ["n|<Leader>fs"] = map_cmd('<cmd>lua require"utils.telescope".find_string()<CR>', "Find a string")
        :with_noremap()
        :with_silent(),
    ["n|<Leader>ft"] = map_cmd(
        '<cmd>lua require"utils.telescope".search_only_certain_files()<CR>',
        "Certain File search"
    )
        :with_noremap()
        :with_silent(),
    ...
    -- grep
    ["n|<Leader>fW"] = map_cmd(
        [['<cmd>lua require"telescope.builtin".live_grep()<cr>' . expand('<cword>')]],
        "Live grep"
    )
        :with_expr()
        :with_silent(),
    ...
    ["n|<Leader>fu"] = map_cmd('<cmd>lua require"utils.telescope".git_diff()<CR>', "show git diff")
        :with_noremap()
        :with_silent(),
    ["n|<Leader>fb"] = map_cmd('<cmd>lua require("utils.telescope").file_browser()<cr>', "file browser")
        :with_noremap()
        :with_silent(),
    ...
    ["n|<Leader>ch"] = map_cmd('<cmd>lua require"utils.telescope".command_history()<CR>', "Command History")
        ...
        :with_silent(),
    -- Dot files
    ["n|<Leader>fd"] = map_cmd('<cmd>lua require"utils.telescope".load_dotfiles()<CR>', "Dotfiles")
        :with_noremap()
        :with_silent(),
    -- Jump
    ["n|<Leader>fj"] = map_cmd('<cmd>lua require"utils.telescope".jump()<CR>', "Mark jump list")
        :with_noremap()
        :with_silent(),
