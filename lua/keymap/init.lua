...
local plug_map = {
    ...
    [{ "n", "<localleader>dpt" }] = map_cmd(
        '<cmd>lua require"modules.completion.lsp_support".PeekTypeDefinition()<CR>'
    )
        :with_noremap()
        :with_silent(),

    [{ "n", "<localleader>dpi" }] = map_cmd(
        '<cmd>lua require"modules.completion.lsp_support".PeekImplementation()<CR>'
    )
        :with_noremap()
        :with_silent(),
    ...
    [{ "v", "<Leader>ga" }] = map_cmd("<cmd>lua require('utils.telescope').code_actions()<CR>")
        :with_noremap()
        :with_silent(),
    ...
    [{ "n", "<Leader>up" }] = map_cmd('<cmd>lua require"utils.telescope".find_updir()<CR>')
        :with_noremap()
        :with_silent(),
    [{ "n", "<Leader>ff" }] = map_cmd('<cmd>lua require"utils.telescope".find_files()<CR>')
        :with_noremap()
        :with_silent(),
    [{ "n", "<Leader>fff" }] = map_cmd('<cmd>lua require"utils.telescope".files()<CR>'):with_noremap():with_silent(),
    [{ "n", "<Leader>fn" }] = map_cmd('<cmd>lua require"utils.telescope".find_notes()<CR>')
        :with_noremap()
        :with_silent(),
    [{ "n", "<Leader>fs" }] = map_cmd('<cmd>lua require"utils.telescope".find_string()<CR>')
        :with_noremap()
        :with_silent(),
    ...
    [{ "n", "<Leader>gw" }] = map_cmd('<cmd>lua require"utils.telescope".grep_last_search()<CR>')
        :with_noremap()
        :with_silent(),
    ...
    [{ "n", "<Leader>fb" }] = map_cmd('<cmd>lua require("utils.telescope").file_browser()<cr>')
        :with_noremap()
        :with_silent(),
    ...
    [{ "n", "<Leader>ip" }] = map_cmd('<cmd>lua require"utils.telescope".installed_plugins()<CR>')
        :with_noremap()
        :with_silent(),
    [{ "n", "<Leader>ch" }] = map_cmd('<cmd>lua require"utils.telescope".command_history()<CR>')
        :with_noremap()
        :with_silent(),

    -- Dot files
    [{ "n", "<Leader>fd" }] = map_cmd('<cmd>lua require"utils.telescope".load_dotfiles()<CR>')
        :with_noremap()
        :with_silent(),
    ...
    [{ "n", "<Leader>ir" }] = map_cmd('<cmd>lua require"utils.telescope".lsp_references()<CR>')
        :with_noremap()
        :with_silent(),
    ...
    [{ "n", "<RightMouse>" }] = map_cmd("<RightMouse><cmd>lua vim.lsp.buf.definition()<CR>")
        :with_noremap()
        :with_silent(),
