...
^ ^ _<esc>_: Quit     ^ ^
    ...
    heads = {
        ...
        { "v", "<CMD>Telescope REPLShow<CR>", { exit = true, desc = "View REPLs in telescope" } },
        {
            "h",
        ...
        { "a", "<CMD>REPLAttachBufferToREPL<CR>", { exit = true, desc = "Attach current buffer to a REPL" } },
        { "d", "<CMD>REPLDetachBufferToREPL<CR>", { exit = true, desc = "Detach current buffer to any REPL" } },
        {
            "<esc>",
            nil,
            { exit = true, desc = "quit" },
