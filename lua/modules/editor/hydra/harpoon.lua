...
^ ^ _5_: open harpoon file 5    _a_: add file                            ^ ^
^ ^ _6_: open harpoon file 6    _;_: toggle quick menu            ^ ^
^ ^ _7_: open harpoon file 7    _<Enter>_: toggle file                   ^ ^
...
Hydra({
    ...
    heads = {
        ...
        { "<Enter>", [[<cmd>lua require("harpoon.mark").toggle_file()<CR>]], { exit = true } },
        { ";", [[<cmd>lua require("harpoon.ui").toggle_quick_menu()<CR>]], { exit = true } },
