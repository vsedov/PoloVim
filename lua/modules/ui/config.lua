...
function config.noice()
    require("noice").setup({
        ...
        lsp = {
            ...
            --  TODO: (vsedov) (03:28:24 - 30/10/22): This just breaks everything
            override = {
            ...
            hover = {
                --  TODO: (vsedov) (03:28:35 - 30/10/22): This also does not work well enough
                enabled = true,
            ...
            signature = {
                ...
                auto_open = {
                    ...
                    throttle = 5, -- Debounce lsp signature help request by 50ms
                },
            },
            message = {
