...
local M = {}
local utils = require("modules.lsp.lsp.providers.python.inlay_hint_core.utils")
local config = require("modules.lsp.lsp.providers.python.inlay_hint_core.config")
...
function M.setup_autocmd()
    ...
    vim.api.nvim_create_autocmd(vim.split(events, ","), {
        ...
        buffer = 0,
        callback = function()
            require("modules.lsp.lsp.providers.python.inlay_hint_core").inlay_hints()
        end,
    })
end
